...
val rdd5 = sc.textFile("/home/centos/Datos/Jefes/otro.txt")
...
df1.coalesce(1).write.mode("overwrite").json("/home/centos/Datos/Jefes/Section1/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/Datos/Jefes/Section1/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/Datos/Jefes/Section1/"+file), new Path("/home/centos/Datos/Jefes/Section1/seccion1.json"));

df2.coalesce(1).write.mode("overwrite").json("/home/centos/Datos/Jefes/Section2/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/Datos/Jefes/Section2/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/Datos/Jefes/Section2/"+file), new Path("/home/centos/Datos/Jefes/Section2/seccion2.json"));

df3.coalesce(1).write.mode("overwrite").json("/home/centos/Datos/Jefes/Section3/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/Datos/Jefes/Section3/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/Datos/Jefes/Section3/"+file), new Path("/home/centos/Datos/Jefes/Section3/seccion3.json"));
