...
val rdd1 = sc.textFile("/home/centos/Datos/Internacionales/seccion1.txt")
val rdd2 = sc.textFile("/home/centos/Datos/Internacionales/seccion2.txt")
val rdd3 = sc.textFile("/home/centos/Datos/Internacionales/seccion3.txt")
val rdd5 = sc.textFile("/home/centos/Datos/Internacionales/otro.txt")
...
df1.coalesce(1).write.mode("overwrite").json("/home/centos/Datos/Internacionales/Section1/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/Datos/Internacionales/Section1/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/Datos/Internacionales/Section1/"+file), new Path("/home/centos/Datos/Internacionales/Section1/seccion1.json"));

df2.coalesce(1).write.mode("overwrite").json("/home/centos/Datos/Internacionales/Section2/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/Datos/Internacionales/Section2/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/Datos/Internacionales/Section2/"+file), new Path("/home/centos/Datos/Internacionales/Section2/seccion2.json"));

df3.coalesce(1).write.mode("overwrite").json("/home/centos/Datos/Internacionales/Section3/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/Datos/Internacionales/Section3/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/Datos/Internacionales/Section3/"+file), new Path("/home/centos/Datos/Internacionales/Section3/seccion3.json"));
