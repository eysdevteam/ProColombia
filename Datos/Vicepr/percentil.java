...
val rdd1 = sc.textFile("/home/centos/Datos/Vicepr/seccion1.txt")
val rdd2 = sc.textFile("/home/centos/Datos/Vicepr/seccion2.txt")
val rdd3 = sc.textFile("/home/centos/Datos/Vicepr/seccion3.txt")
val rdd5 = sc.textFile("/home/centos/Datos/Vicepr/otro.txt")
...
df1.coalesce(1).write.mode("overwrite").json("/home/centos/Datos/Vicepr/Section1/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/Datos/Vicepr/Section1/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/Datos/Vicepr/Section1/"+file), new Path("/home/centos/Datos/Vicepr/Section1/seccion1.json"));

df2.coalesce(1).write.mode("overwrite").json("/home/centos/Datos/Vicepr/Section2/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/Datos/Vicepr/Section2/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/Datos/Vicepr/Section2/"+file), new Path("/home/centos/Datos/Vicepr/Section2/seccion2.json"));

df3.coalesce(1).write.mode("overwrite").json("/home/centos/Datos/Vicepr/Section3/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/Datos/Vicepr/Section3/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/Datos/Vicepr/Section3/"+file), new Path("/home/centos/Datos/Vicepr/Section3/seccion3.json"));
