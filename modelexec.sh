...
if 
 ...
 then
	echo "Bajando repositorio ProColombia"
      ...
      sudo ssh -oStrictHostKeyChecking=no -i /home/centos/cluster_test_biba.pem centos@$IP "sudo chown apache:apache -R /var/www/html/DashboardProc"     
      sudo ssh -oStrictHostKeyChecking=no -i /home/centos/cluster_test_biba.pem centos@$IP "sudo chmod 777 -R /var/www/html/DashboardProc"     
