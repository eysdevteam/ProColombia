...
val rdd1 = sc.textFile("/home/centos/DatosAmericas/Analistas/seccion1.txt")
val rdd2 = sc.textFile("/home/centos/DatosAmericas/Analistas/seccion2.txt")
val rdd3 = sc.textFile("/home/centos/DatosAmericas/Analistas/seccion3.txt")
val rdd5 = sc.textFile("/home/centos/DatosAmericas/Analistas/otro.txt")
...
df1.coalesce(1).write.mode("overwrite").json("/home/centos/DatosAmericas/Analistas/Section1/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosAmericas/Analistas/Section1/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosAmericas/Analistas/Section1/"+file), new Path("/home/centos/DatosAmericas/Analistas/Section1/seccion1.json"));

df2.coalesce(1).write.mode("overwrite").json("/home/centos/DatosAmericas/Analistas/Section2/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosAmericas/Analistas/Section2/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosAmericas/Analistas/Section2/"+file), new Path("/home/centos/DatosAmericas/Analistas/Section2/seccion2.json"));

df3.coalesce(1).write.mode("overwrite").json("/home/centos/DatosAmericas/Analistas/Section3/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosAmericas/Analistas/Section3/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosAmericas/Analistas/Section3/"+file), new Path("/home/centos/DatosAmericas/Analistas/Section3/seccion3.json"));
...
dfPS.drop("id").coalesce(1).write.mode("overwrite").json("/var/www/html/AmericasBps/DashboardABps/web/Analistas/bullet/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/var/www/html/AmericasBps/DashboardABps/web/Analistas/bullet/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/AmericasBps/DashboardABps/web/Analistas/bullet/"+file), new Path("/var/www/html/AmericasBps/DashboardABps/web/Analistas/bullet/bullet.json"));
 

//Export data donuts graph

val dfK = k.toDF("Colaboradores").withColumn("total",lit(100))
dfK.coalesce(1).write.mode("overwrite").format("com.databricks.spark.csv").option("header", "FALSE").save("/var/www/html/AmericasBps/DashboardABps/web/Analistas/donut/")
val file = fs.globStatus(new Path("/var/www/html/AmericasBps/DashboardABps/web/Analistas/donut/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/AmericasBps/DashboardABps/web/Analistas/donut/"+file), new Path("/var/www/html/AmericasBps/DashboardABps/web/Analistas/donut/donut.json"));
