...
val rdd1 = sc.textFile("/home/centos/DatosAmericas/Directores/seccion1.txt")
val rdd2 = sc.textFile("/home/centos/DatosAmericas/Directores/seccion2.txt")
val rdd3 = sc.textFile("/home/centos/DatosAmericas/Directores/seccion3.txt")
val rdd5 = sc.textFile("/home/centos/DatosAmericas/Directores/otro.txt")
...
df1.coalesce(1).write.mode("overwrite").json("/home/centos/DatosAmericas/Directores/Section1/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosAmericas/Directores/Section1/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosAmericas/Directores/Section1/"+file), new Path("/home/centos/DatosAmericas/Directores/Section1/seccion1.json"));

df2.coalesce(1).write.mode("overwrite").json("/home/centos/DatosAmericas/Directores/Section2/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosAmericas/Directores/Section2/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosAmericas/Directores/Section2/"+file), new Path("/home/centos/DatosAmericas/Directores/Section2/seccion2.json"));

df3.coalesce(1).write.mode("overwrite").json("/home/centos/DatosAmericas/Directores/Section3/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosAmericas/Directores/Section3/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosAmericas/Directores/Section3/"+file), new Path("/home/centos/DatosAmericas/Directores/Section3/seccion3.json"));
...
dfPS.drop("id").coalesce(1).write.mode("overwrite").json("/var/www/html/AmericasBps/DashboardABps/web/Directores/bullet/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/var/www/html/AmericasBps/DashboardABps/web/Directores/bullet/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/AmericasBps/DashboardABps/web/Directores/bullet/"+file), new Path("/var/www/html/AmericasBps/DashboardABps/web/Directores/bullet/bullet.json"));
 

//Export data donuts graph

val dfK = k.toDF("Colaboradores").withColumn("total",lit(13))
dfK.coalesce(1).write.mode("overwrite").format("com.databricks.spark.csv").option("header", "FALSE").save("/var/www/html/AmericasBps/DashboardABps/web/Directores/donut/")
val file = fs.globStatus(new Path("/var/www/html/AmericasBps/DashboardABps/web/Directores/donut/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/AmericasBps/DashboardABps/web/Directores/donut/"+file), new Path("/var/www/html/AmericasBps/DashboardABps/web/Directores/donut/donut.json"));
