...
val rdd1 = sc.textFile("/home/centos/DatosAmericas/Jefes/seccion1.txt")
val rdd2 = sc.textFile("/home/centos/DatosAmericas/Jefes/seccion2.txt")
val rdd3 = sc.textFile("/home/centos/DatosAmericas/Jefes/seccion3.txt")
val rdd5 = sc.textFile("/home/centos/DatosAmericas/Jefes/otro.txt")
...
df1.coalesce(1).write.mode("overwrite").json("/home/centos/DatosAmericas/Jefes/Section1/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosAmericas/Jefes/Section1/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosAmericas/Jefes/Section1/"+file), new Path("/home/centos/DatosAmericas/Jefes/Section1/seccion1.json"));

df2.coalesce(1).write.mode("overwrite").json("/home/centos/DatosAmericas/Jefes/Section2/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosAmericas/Jefes/Section2/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosAmericas/Jefes/Section2/"+file), new Path("/home/centos/DatosAmericas/Jefes/Section2/seccion2.json"));

df3.coalesce(1).write.mode("overwrite").json("/home/centos/DatosAmericas/Jefes/Section3/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosAmericas/Jefes/Section3/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosAmericas/Jefes/Section3/"+file), new Path("/home/centos/DatosAmericas/Jefes/Section3/seccion3.json"));
...
dfPS.drop("id").coalesce(1).write.mode("overwrite").json("/var/www/html/AmericasBps/DashboardABps/web/Jefes/bullet/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/var/www/html/AmericasBps/DashboardABps/web/Jefes/bullet/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/AmericasBps/DashboardABps/web/Jefes/bullet/"+file), new Path("/var/www/html/AmericasBps/DashboardABps/web/Jefes/bullet/bullet.json"));
 

//Export data donuts graph

val dfK = k.toDF("Colaboradores").withColumn("total",lit(15))
dfK.coalesce(1).write.mode("overwrite").format("com.databricks.spark.csv").option("header", "FALSE").save("/var/www/html/AmericasBps/DashboardABps/web/Jefes/donut/")
val file = fs.globStatus(new Path("/var/www/html/AmericasBps/DashboardABps/web/Jefes/donut/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/AmericasBps/DashboardABps/web/Jefes/donut/"+file), new Path("/var/www/html/AmericasBps/DashboardABps/web/Jefes/donut/donut.json"));
