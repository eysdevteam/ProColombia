//Importar librerÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â­as
...
case class Obs3( q1: String, q2: String, 
	q3: String, q4: String, q5: String, q6: String, q7: String, q8: String, q9: String, q10: String, q11: String, q12: String, q13: String, q14: String)
...
def parseObs3(line: Array[String]): Obs3 = {
    Obs3( line(0), line(1), line(2), line(3), line(4), line(5), line(6), line(7), line(8), line(9), line(10), line(11), line(12), line(13) ) }
...
val rdd1 = sc.textFile("/home/centos/DatosProcolombia/Internacionales/seccion1.txt")
val rdd2 = sc.textFile("/home/centos/DatosProcolombia/Internacionales/seccion2.txt")
val rdd3 = sc.textFile("/home/centos/DatosProcolombia/Internacionales/seccion3.txt")
val rdd5 = sc.textFile("/home/centos/DatosProcolombia/Internacionales/otro.txt")
...
val df323 =  df322.join(df5).where(df322("q13")===df5("k2")).drop("q13","k2").withColumnRenamed("k1","M13")
val df324 =  df323.join(df5).where(df323("q14")===df5("k2")).drop("q14","k2").withColumnRenamed("k1","N14")
...
df1.coalesce(1).write.mode("overwrite").json("/home/centos/DatosProcolombia/Internacionales/Section1/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosProcolombia/Internacionales/Section1/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosProcolombia/Internacionales/Section1/"+file), new Path("/home/centos/DatosProcolombia/Internacionales/Section1/seccion1.json"));

df2.coalesce(1).write.mode("overwrite").json("/home/centos/DatosProcolombia/Internacionales/Section2/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosProcolombia/Internacionales/Section2/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosProcolombia/Internacionales/Section2/"+file), new Path("/home/centos/DatosProcolombia/Internacionales/Section2/seccion2.json"));

df3.coalesce(1).write.mode("overwrite").json("/home/centos/DatosProcolombia/Internacionales/Section3/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/home/centos/DatosProcolombia/Internacionales/Section3/part*"))(0).getPath().getName();
fs.rename(new Path("/home/centos/DatosProcolombia/Internacionales/Section3/"+file), new Path("/home/centos/DatosProcolombia/Internacionales/Section3/seccion3.json"));
...
//Almacenar en un solo Array el percentil de cada pregunta de la secciÃƒÂ³n 1 
...
//Almacenar en un solo Array el percentil de cada pregunta de la secciÃƒÂ³n 2 
...
//Almacenar en un solo Array el percentil de cada pregunta de la secciÃƒÂ³n 3
...
dfPS.drop("id").coalesce(1).write.mode("overwrite").json("/var/www/html/DashboardProc/web/Internacionales/bullet/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/var/www/html/DashboardProc/web/Internacionales/bullet/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/DashboardProc/web/Internacionales/bullet/"+file), new Path("/var/www/html/DashboardProc/web/Internacionales/bullet/bullet.json"));
 

//Export data donuts graph

val dfK = k.toDF("Colaboradores").withColumn("total",lit(50))
dfK.coalesce(1).write.mode("overwrite").format("com.databricks.spark.csv").option("header", "FALSE").save("/var/www/html/DashboardProc/web/Internacionales/donut/")
val file = fs.globStatus(new Path("/var/www/html/DashboardProc/web/Internacionales/donut/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/DashboardProc/web/Internacionales/donut/"+file), new Path("/var/www/html/DashboardProc/web/Internacionales/donut/donut.json"));
