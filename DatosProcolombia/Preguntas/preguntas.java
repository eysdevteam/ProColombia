...
val df11 = spark.read.json("/home/centos/DatosProcolombia/Vicepr/Section1/seccion1.json")
val df12 = spark.read.json("/home/centos/DatosProcolombia/Vicepr/Section2/seccion2.json")
val df13 = spark.read.json("/home/centos/DatosProcolombia/Vicepr/Section3/seccion3.json")


val df21 = spark.read.json("/home/centos/DatosProcolombia/Jefes/Section1/seccion1.json")
val df22 = spark.read.json("/home/centos/DatosProcolombia/Jefes/Section2/seccion2.json")
val df23 = spark.read.json("/home/centos/DatosProcolombia/Jefes/Section3/seccion3.json")


val df31 = spark.read.json("/home/centos/DatosProcolombia/Nacionales/Section1/seccion1.json")
val df32 = spark.read.json("/home/centos/DatosProcolombia/Nacionales/Section2/seccion2.json")
val df33 = spark.read.json("/home/centos/DatosProcolombia/Nacionales/Section3/seccion3.json")


val df41 = spark.read.json("/home/centos/DatosProcolombia/Internacionales/Section1/seccion1.json")
val df42 = spark.read.json("/home/centos/DatosProcolombia/Internacionales/Section2/seccion2.json")
val df43 = spark.read.json("/home/centos/DatosProcolombia/Internacionales/Section3/seccion3.json")
...
val dfname1 = spark.read.csv("/home/centos/DatosProcolombia/Preguntas/names1.txt").withColumnRenamed("_c0","name")
val dfname11 = dfname1.withColumn("id", monotonicallyIncreasingId+1.toInt)


val dfname2 = spark.read.csv("/home/centos/DatosProcolombia/Preguntas/names2.txt").withColumnRenamed("_c0","name")
val dfname12 = dfname2.withColumn("id", monotonicallyIncreasingId+1.toInt)


val dfname3 = spark.read.csv("/home/centos/DatosProcolombia/Preguntas/names3.txt").withColumnRenamed("_c0","name")
val dfname13 = dfname1.withColumn("id", monotonicallyIncreasingId+1.toInt)


//Definir estrutuctura de datos x sección y por pregunta (ejm 15 seccion 1 pregunta 5)
...
//Estructura si existen valores con esa categoría
...
//Generar estrucutyra final, verificando la condición
...
dfes011.coalesce(1).write.mode("overwrite").json("/var/www/html/DashboardProc/web/Preguntas/seccion1/file1/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion1/file1/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion1/file1/"+file), new Path("/var/www/html/DashboardProc/web/Preguntas/seccion1/file1/data.json"));
 

dfes012.coalesce(1).write.mode("overwrite").json("/var/www/html/DashboardProc/web/Preguntas/seccion2/file1/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion2/file1/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion2/file1/"+file), new Path("/var/www/html/DashboardProc/web/Preguntas/seccion2/file1/data.json"));


dfes013.coalesce(1).write.mode("overwrite").json("/var/www/html/DashboardProc/web/Preguntas/seccion3/file1/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion3/file1/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion3/file1/"+file), new Path("/var/www/html/DashboardProc/web/Preguntas/seccion3/file1/data.json"));




dfes021.coalesce(1).write.mode("overwrite").json("/var/www/html/DashboardProc/web/Preguntas/seccion1/file2/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion1/file2/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion1/file2/"+file), new Path("/var/www/html/DashboardProc/web/Preguntas/seccion1/file2/data.json"));

dfes022.coalesce(1).write.mode("overwrite").json("/var/www/html/DashboardProc/web/Preguntas/seccion2/file2/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion2/file2/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion2/file2/"+file), new Path("/var/www/html/DashboardProc/web/Preguntas/seccion2/file2/data.json"));


dfes023.coalesce(1).write.mode("overwrite").json("/var/www/html/DashboardProc/web/Preguntas/seccion3/file2/")
val fs = FileSystem.get(sc.hadoopConfiguration);
val file = fs.globStatus(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion3/file2/part*"))(0).getPath().getName();
fs.rename(new Path("/var/www/html/DashboardProc/web/Preguntas/seccion3/file2/"+file), new Path("/var/www/html/DashboardProc/web/Preguntas/seccion3/file2/data.json"));
